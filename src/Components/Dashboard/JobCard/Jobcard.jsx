...
function Jobcard({job}) {
    ...
    return (
        <div className="card ma1 bg-white ph3 mt3 br3 flex justify-between items-center">
            <div className='flex flex-1 flex-2-mo flex-column '>
            ...
            <div className='flex flex-1 flex-column items-center'>
                <p className='ma0 dn db-m db-l mb2_2 gray f7_2 f10-m f10-mo'>No. of Candidates </p>
                <p className='ma0 gray mb3 gray f7_2 f9-m f9-mo'>0</p>
            </div>
            <div className='h-100 flex-1 flex flex-column w-25-l w-40-m w-30'>
                ...
                <div className='flex justify-center flex-row-l flex-row-m flex-column justify-center items-center'>
                    ...
                    <button onClick={() => history.push("/Editjob")} style={{color:"#265cff"}} className="bg-white pointer ml2-l ml2-m ml3 c-shadow f9-mo f8-m f7-l w-40-l w-50-m w-90 h2-l h2-m h7-mo mt1 mt0-l mt0-m bn link dim br2 ph3 pv2 dib">Edit Job</button>
               </div>
            </div>
        </div>
    )
