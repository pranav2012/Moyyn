    ...
    return (
        ...
        <div className='w-90 center mb5'>
            <div className='flex justify-between items-center'>
                ...
                <button style={{background:"#265cff"}} className="mt3 h2 pointer h7-mo fw6 f9-mo f7-m f6-l mr2 w4-l w4-m w7-mo bn link dim br2 ph3 pv2 dib white">Post a Job</button>
            </div>
