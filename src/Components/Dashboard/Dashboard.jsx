    ...
    return (
        ...
        <div className='w-90 center mb5'>
            <div className='flex mt4 mb3 center justify-between w-90 items-center'>
                ...
                <button style={{background:"#265cff"}} className="h2 pointer h7-mo fw6 f8-mo f7-m f6-l mr2 w-20-l w-20-m w4 bn link dim br2 ph3 pv2 dib white">Post a Job</button>
            </div>
