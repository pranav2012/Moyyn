        ...
        <div className='w-90 center mb5'>
            <div className='flex justify-between items-center'>
                <div>
                    ...
                    <p className='mb4-l mb4-m mb3 f5-l f6-m f9 gray ma0'>Get candidates by our A.I system</p>
                </div>
                <button style={{background:"#265cff"}} className="mt3 h2 pointer fw6 f8 f7-m f6-l mr2 w4-l w4-m w7 bn link dim br2 ph3 pv2 dib white">Post a Job</button>
            </div>
